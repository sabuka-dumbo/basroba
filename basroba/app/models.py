...
class Product(models.Model):
    ...
    Product_color1 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color1", default="")
    Product_color2 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color2", default="")
    Product_color3 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color3", default="")
    Product_color4 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color4", default="")
    Product_color5 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color5", default="")
    Product_color6 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color6", default="")
    Product_color7 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color7", default="")
    Product_color8 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color8", default="")
    Product_color9 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color9", default="")
    Product_color10 = models.ForeignKey(Color, on_delete=models.CASCADE, related_name="color10", default="")
